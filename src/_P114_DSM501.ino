    ...
    case PLUGIN_READ:
      {
        if (done1 && done2) {
          ...
          log+=F(" Part=");
          float r1=Plugin_114_weight(ratio1);
          float r2=Plugin_114_weight(ratio2);
          log+=r1;
          log+=F("/");
          log+=r2;
          log+=F(" AQI=");
          log+= Plugin_114_AQI(r1, r2);
          addLog(LOG_LEVEL_INFO, log);
        }  
